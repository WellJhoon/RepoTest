...
class TestSearh():
    ...
    def test_login_succes(self,Test_inicialP):
        self.page.login_succes('haroldy@gmail.com','1234')
    ...
    def test_blocked_users_succes(self,Test_inicialP):
        self.page.blocked_users_succes('haroldy@gmail.com','1234')

    def test_contact_empty_fail(self,Test_inicialP):
        self.page.contact_empty_fail('haroldy@gmail.com','1234', '', '', '', '')

    def test_contact_empty_succes(self,Test_inicialP):
        self.page.contact_empty_succes('haroldy@gmail.com','1234', 'Carlos', 'Castillo', '8494535632', 'Santo Domingo')

    def test_search_fail(self, Test_inicialP):
        self.page.search_fail('haroldy@gmail.com', '1234', 'Ronaldo')

    def test_search_succes(self,Test_inicialP):
        self.page.search_succes('haroldy@gmail.com','1234', 'Haroldy', 'Carlos', 'Castillo', '8494535632', 'Santo Domingo')

    def test_storage_empty_fail(self, Test_inicialP):
        self.page.storage_empty_fail('haroldy@gmail.com', '1234')

    def test_storage_empty_succes(self,Test_inicialP):
        self.page.storage_empty_succes('haroldy@gmail.com','1234', 'Carlos', 'Castillo', '849453632', 'Santo Domingo')

    def test_add_contact_fail(self,Test_inicialP):
        self.page.add_contact_fail('haroldy@gmail.com','1234', 'josess39@gmail.com', 'Castillo', '8494535632', 'Santo Domingo')

    def test_add_contact_succes(self,Test_inicialP):
        self.page.add_contact_succes('haroldy@gmail.com','1234', 'Johan', 'Castillo', '83556323', 'Puerto Plata')

    def test_dark_mode_fail(self,Test_inicialP):
        self.page.dark_mode_fail('haroldy@gmail.com','1234', 'Alex')

    def test_dark_mode_succes(self,Test_inicialP):
        self.page.dark_mode_succes('haroldy@gmail.com','1234')

    def test_logOut_fail(self,Test_inicialP):
        self.page.logOut_fail('haroldy@gmail.com','1234', 'Haroldy')

    def test_logOut_succes(self,Test_inicialP):
        self.page.logOut_succes('haroldy@gmail.com','1234')

    def test_user_correct_fail(self, Test_inicialP):
        self.page.user_correct_fail('haroldygrg', '1234')

    def test_user_correct_succes(self, Test_inicialP):
        self.page.user_correct_succes('haroldy@gmail.com', '1234')

    def test_isNaN_number_fail(self,Test_inicialP):
        self.page.isNaN_number_fail('haroldy@gmail.com','1234', 'Johan', 'Castillo', 'gfg23423', 'Puerto Plata')

    def test_isNaN_number_succes(self,Test_inicialP):
        self.page.isNaN_number_succes('haroldy@gmail.com','1234', 'Johan', 'Castillo', '82943213', 'Puerto Plata')